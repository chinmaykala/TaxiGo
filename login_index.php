            ...
            <div class="resp-tabs-container hor_1">
               <div class="w3_agile_login">
                    <form action="check_login.php" method="post" class="agile_form">
					  ...
					  <input type="submit" value="LogIn" class="agileinfo" name="login"style="width:90%;" />
					  <img src="https://www.animatedimages.org/data/media/67/animated-car-image-0021.gif" style="width:90 %;" border="0" alt="animated-car-image-0021" />
					</form>
