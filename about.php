				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 about-right">
							<h1>Connected across India by Large Network</h1>
							<h4>We are here to listen from you to deliver exellence</h4>
			...
			<section class="services-area pb-120">
				<div class="container">
					<div class="row section-title">
						<h1>Our Team</h1>
						<p>Want to know who are the developers of this website?</p>
					</div>
					<div class="row">
						<div class="col-lg-2 section-gap">
							
						</div>
						<div class="col-lg-4 single-service">
							<span class="lnr lnr-briefcase"></span>
							<a href="#"><h4>Chinmay Kala</h4></a>
							<p>
								Team Leader
							</p>
						</div>
